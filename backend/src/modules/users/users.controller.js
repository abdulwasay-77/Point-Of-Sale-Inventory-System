...
class UsersController {
  ...
  deactivate = asyncHandler(async (req, res) => {
    const user = await UsersService.deactivate(req.params.id, req.user.userId);
  ...
  setPermissions = asyncHandler(async (req, res) => {
    ...
    const user = await UsersService.setPermissions(req.params.id, req.body.permissions, req.user.userId);
