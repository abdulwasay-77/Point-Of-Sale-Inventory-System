...
export default function ProductsPage() {
  ...
  const canEdit = has('PRODUCTS_EDIT')
  const canDelete = has('PRODUCTS_DELETE')
                  ...
                  <tr key={product.id} className="group">
                    <td>
                      <div className="flex items-center gap-3">
                        <div className="h-9 w-9 rounded-lg bg-paper-dim dark:bg-dark-card2 border border-line dark:border-dark-border shrink-0 overflow-hidden flex items-center justify-center transition-all duration-300 group-hover:border-amber group-hover:shadow-[0_0_0_1px_rgba(232,163,61,0.4),0_0_10px_1px_rgba(232,163,61,0.25)] group-hover:scale-105">
                          {product.image ? (
                            <img
                        ...
                        <span className="font-medium transition-colors duration-200 group-hover:text-amber-dark dark:group-hover:text-amber">
                          {product.name}
                        </span>
                      </div>
                    </td>
