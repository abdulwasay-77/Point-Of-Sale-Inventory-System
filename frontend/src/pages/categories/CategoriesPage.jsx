...
export default function CategoriesPage() {
  ...
  const canManage = has('CATEGORIES_MANAGE')
            ...
            <table className="table-base table-premium">
              ...
              <tbody>
                {paginated.map((category) => {
                  ...
                  return (
                    <tr key={category.id} className={`group ${isEmpty ? 'bg-rose-light/20 dark:bg-dark-rose/15' : ''}`}>
                      <td>
                        <div className="flex items-center gap-3">
                          ...
                          {isEmpty && (
                            <span className="inline-flex items-center gap-1.5">
                              ...
                              <span className="text-[11px] font-semibold text-rose dark:text-dark-rose uppercase tracking-wide">
                                Empty
                              </span>
                            </span>
                          )}
                      ...
                      <td className="text-ink-muted dark:text-dark-muted">{category.description || '—'}</td>
                      <td>
