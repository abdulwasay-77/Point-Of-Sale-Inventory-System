...
export default function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center py-16 px-6">
      ...
      <h3 className="font-display text-base font-semibold text-ink dark:text-dark-text">{title}</h3>
      <p className="text-sm text-ink-muted dark:text-dark-muted mt-1 max-w-sm">{description}</p>
